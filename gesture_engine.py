...
GESTURE_SHAPES = {
    ...
    "spider": {
        "name": "Spider / Claw", "icon": "🕷️",
        "desc": "All 5 fingers spread wide and curved like a spider or claw",
        "fingers": [None, None, None, None, None],  # custom validator handles this
        "extended_count": None,                      # skip count check
        "spider_check": True,  # triggers curvature-based validation
    },
    ...
    "pinching": {
        "name": "Pinching Hand", "icon": "🤏",
        "desc": "Thumb and index close together, others curled — pinch gesture",
        "fingers": [True, True, False, False, False],
        "extended_count": 2,
        "strict": True,
    },
    ...
    "raised_hand": {
        ...
        "desc": "All 5 fingers extended — same as open palm",
        "fingers": [True, True, True, True, True],
        "extended_count": 5,
        "strict": True,
    },
    ...
    "waving": {
        ...
        "desc": "Open hand waving — all 5 fingers extended",
        "fingers": [True, True, True, True, True],
        "extended_count": 5,
        "strict": True,
    },
    ...
    "love_you": {
        "name": "Love-You Gesture", "icon": "🤟",
        "desc": "Thumb, index, and pinky extended; middle and ring curled",
    ...
    "index_pointing_up": {
        "name": "Index Pointing Up", "icon": "☝️",
        "desc": "Only index finger extended straight up",
        "fingers": [False, True, False, False, False],
        "extended_count": 1,
        "strict": True,
    },
...
# 10 free-form custom gesture slots — no shape constraint, pure ML classification.
# Users can record ANY hand pose they like for these.
FREEFORM_GESTURES = {
    f"custom_{i+1}": {
                ...
                if results.multi_hand_landmarks:
                    ...
                    # ── Normal processing ─────────────────────────────────────
                        ...
                        if (self.custom_gesture_enabled and
                            ...
                            gid, conf = None, 0.0
                            if has_any_match:
                                gid, conf = self.predictor.predict(landmarks)

                            if gid and gid not in self.custom_actions_map:
                                gid, conf = None, 0.0

                            if gid and conf > 0.70:
                                shape = self._configured_shapes.get(gid)
